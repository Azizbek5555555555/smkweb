...
export default function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>
          SMK Web — IT компания Самарканд | Web studio Uzbekistan | Mobil
          ilovalar, SEO xizmatlar, веб разработка
        </title>
        <meta charSet="UTF-8" />
      ...
      <section className="p-6 bg-white text-black">
        <h2 className="text-2xl font-bold mb-4">Bizning xizmatlar</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {products.map((product, index) => (
            <div
              key={index}
              className="border p-4 rounded-2xl shadow transition hover:shadow-lg bg-gray-50"
            >
