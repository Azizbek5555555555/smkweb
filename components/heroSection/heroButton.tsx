...
export function HeroButton({}) {
  ...
  return (
    ...
    >
      <div className="shapka !flex items-center justify-center gap-[5.5rem]">
        <div className="round hidden items-center justify-center md:flex">
          <p className="absolute left-[37%] whitespace-nowrap text-[21px]">
            <span>
              <span className="scrambleText">Добро пожаловать</span>
              <br />
              <span className="scrambleText">в SMKWEB</span>
            </span>
          </p>
        </div>
